...
function view(snap, {
  ...
  return {
    ...
    excludedComponents: (exclude || []).filter(Boolean),
    excludedEpics,
    ...
    coverageTeams: (teams || []).filter(Boolean),
    excludedByTeam,
    teamValues,
...
module.exports = {
  view, assess, bucketOf, toolOf, hasTool, productComponents, excludeSet, familyOf, scoped, NO_TEAM,
